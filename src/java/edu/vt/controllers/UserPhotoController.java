    ...
    ************************
    ...
    public String upload() {
        ...
        */
        ...
        if (signedInUser.getUsername().equals("Administrator")){
            // Redirect to show the Profile page
            return "/adminMenu/AdminProfile?faces-redirect=true";
        }
        if (signedInUser.getOrganizer() == 0){
        // Redirect to show the Profile page
        return "/participant/ParticipantProfile?faces-redirect=true";
        }
        // Redirect to show the Profile page
        return "/eventOrganizer/OrganizerProfile?faces-redirect=true";
